...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\nick_\PycharmProjects\pythonProject\day-69 blog-with-users-start\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\nick_\PycharmProjects\pythonProject\day-69 blog-with-users-start\venv\Scripts\deactivate.nu'
